        ...
        <div class="row m-5">
            ...
            <div class="col">
                <form method="post" enctype="multipart/form-data" class="text-center">
                    ...
                    <div class="mb-3">
                        <label for="product_name" class="form-label text-danger">Название</label>
                        <input type="text" class="rounded-0 form-control @error('product_name') is-invalid @enderror" id="product_name" name="product_name">
                        @error('product_name')
...
{{--                    </div>--}}
                    <div class="mb-3">
                        <label for="product_count" class="form-label text-danger">Количество</label>
                        <input type="number" class="rounded-0 form-control @error('product_name') is-invalid @enderror" id="product_count" name="product_count">
                        @error('product_count')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-3">
                        <label for="product_price" class="form-label text-danger">Цена</label>
                        <input type="number" class="rounded-0 form-control @error('product_price') is-invalid @enderror" id="product_price" name="product_price">
                        @error('product_price')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-3">
                        <label for="category_id" class="form-label text-danger">Категории</label>
                        <select type="text" class="rounded-0 form-control @error('category_id') is-invalid @enderror" id="category_id" name="category_id">
                    ...
                    <div class="mb-3">
                        <label for="product_photo" class="form-label text-danger">Фото</label>
                        <input type="file" class="rounded-0 form-control @error('product_photo') is-invalid @enderror" id="product_photo" name="product_photo">
                        @error('product_photo')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-3">
                        <label for="product_description" class="form-label text-danger">Описание</label>
                    ...
                    <button type="submit" class="btn btn-dark btn-lg rounded-0">Добавить</button>
                </form>
            </div>
            <div class="col"></div>
        </div>
